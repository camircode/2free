...
import { loadAuthConfig, type AuthConfig } from "@2free/auth/config.js";

export type RuntimeProfile = "compose-cloud-dev" | "cloud-test" | "local-offline" | "ci";
...
export function loadRuntimeConfig(env: NodeJS.ProcessEnv = process.env): RuntimeConfig {
  ...
  if (!["compose-cloud-dev", "cloud-test", "local-offline", "ci"].includes(profile)) {
